...
typedef void (*RelativeStepsCtrlCallback)(int j0, int j1, int j2, int j3);
...
class Wireless{
    public:
        ...
        String getMac();
        bool sendEspNowSteps(uint8_t mac[6], int j0, int j1, int j2, int j3);
        ...
        void setRelativeStepsCtrlCallback(RelativeStepsCtrlCallback callback);
