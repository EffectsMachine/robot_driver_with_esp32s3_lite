...
<body>
    <main>
        <div>
            <section>
                ...
                <h2 class="tittle-h2">Arm FPV Ctrl</h2>
                <div class="set-btn-frame">
                    <div class="set-btn-frame-i">
                        <div class="set-btn-sections">
                            <p id="fpv_r">Reach</p>
                            <div>
                                <button class="btn-num btn-num-bg btn-num-up" onmousedown="cmdSend(1,11,0.5);" ontouchstart="cmdSend(1,11,0.5);" onmouseup="cmdSend(0,-1,0);" ontouchend="cmdSend(0,-1,0)">R+</button>
                                <button class="btn-num btn-num-bg btn-num-down" onmousedown="cmdSend(1,11,-0.5);" ontouchstart="cmdSend(1,11,-0.5);" onmouseup="cmdSend(0,-1,0);" ontouchend="cmdSend(0,-1,0)">R-</button>
                            </div>
                        </div>
                        <div class="set-btn-sections">
                            <p id="fpv_b">Base</p>
                            <div>
                                <button class="btn-num btn-num-bg btn-num-up" onmousedown="cmdSend(1,12,0.002);" ontouchstart="cmdSend(1,12,0.002);" onmouseup="cmdSend(0,-1,0);" ontouchend="cmdSend(0,-1,0)">B+</button>
                                <button class="btn-num btn-num-bg btn-num-down" onmousedown="cmdSend(1,12,-0.002);" ontouchstart="cmdSend(1,12,-0.002);" onmouseup="cmdSend(0,-1,0);" ontouchend="cmdSend(0,-1,0)">B-</button>
                            </div>
                        </div>
                        <div class="set-btn-sections">
                            <p id="fpv_z">Z-axis</p>
                        ...
                        <div class="set-btn-sections">
                            <p id="fpv_g">Gripper</p>
                            <div>
                                <button class="btn-num btn-num-bg btn-num-up" onmousedown="cmdSend(1,14,0.5);" ontouchstart="cmdSend(1,14,0.5);" onmouseup="cmdSend(0,-1,0);" ontouchend="cmdSend(0,-1,0)">Open</button>
                                <button class="btn-num btn-num-bg btn-num-down" onmousedown="cmdSend(1,14,-0.5);" ontouchstart="cmdSend(1,14,-0.5);" onmouseup="cmdSend(0,-1,0);" ontouchend="cmdSend(0,-1,0)">Grab</button>
                            </div>
                        </div>
                    </div>
                    <div class="init-posit">
                        <button class="btn-all btn-main-l btn-all-bg" onclick='sendJsonCmd({"T":139,"rbzg":[260.5,0,122.38,50],"spd":0.4,"br":150});'>INIT</button>
                    </div>
                </div>
                <h2 class="tittle-h2">Arm Cart Ctrl</h2>
                <div class="set-btn-frame">
                    <div class="set-btn-frame-i">
                        <div class="set-btn-sections">
                            <p id="cart_x">X</p>
                        ...
                        <div class="set-btn-sections">
                            <p id="cart_g">Gripper</p>
                            <div>
                                <button class="btn-num btn-num-bg btn-num-up" onmousedown="cmdSend(1,4,0.5);" ontouchstart="cmdSend(1,4,0.5);" onmouseup="cmdSend(0,-1,0);" ontouchend="cmdSend(0,-1,0)">Open</button>
                                <button class="btn-num btn-num-bg btn-num-down" onmousedown="cmdSend(1,4,-0.5);" ontouchstart="cmdSend(1,4,-0.5);" onmouseup="cmdSend(0,-1,0);" ontouchend="cmdSend(0,-1,0)">Grab</button>
                            </div>
                        </div>
                    </div>
                    <div class="init-posit">
                ...
                <div>
                    <h2 class="tittle-h2">Arm Torque Ctrl</h2>
                    <div style="margin-bottom: 20px;">
                        <button class="btn-of btn-all" style="min-width:110px; padding:10px 15px; margin:5px;" onclick='sendJsonCmd({"T":34,"id":254,"state":0});'>Release</button>
                        <button class="btn-of btn-all" style="min-width:110px; padding:10px 15px; margin:5px;" onclick='sendJsonCmd({"T":34,"id":254,"state":1});'>Lock</button>
                    </div>
                </div>
                <div>
            ...
            <section>
                ...
                <div>
                    <div class="fb-input-info">
                        ...
                        <div class="Servo-set">
                            ...
                            <div class="info-box json-cmd-info">
                                <div>
                                    <p>CMD_LINK_ARM_SC_JOINTS_CTRL_ANGLE</p>
                                    <p class="cmd-value">{"T":134,"ang":[0,0,0,0]}</p>
                                </div>
                                <button class="w-btn">INPUT</button>
                            </div>
                            <div class="info-box json-cmd-info">
                                <div>
                                    <p>CMD_LINK_ARM_SC_JOINTS_CTRL_RAD</p>
                                    <p class="cmd-value">{"T":135,"rad":[0,0,0,0]}</p>
                                </div>
                                <button class="w-btn">INPUT</button>
                            </div>
                            <div class="info-box json-cmd-info">
                                <div>
                                    <p>CMD_XYZG_CTRL</p>
                                    <p class="cmd-value">{"T":136,"xyzg":[260.5,0,122.38,50]}</p>
                                </div>
                                <button class="w-btn">INPUT</button>
                            </div>
                            <div class="info-box json-cmd-info">
                                <div>
                                    <p>CMD_FPV_ABS_CTRL</p>
                                    <p class="cmd-value">{"T":137,"rbzg":[260.5,0,122.38,50]}</p>
                                </div>
                                <button class="w-btn">INPUT</button>
                            </div>
                            <div class="info-box json-cmd-info">
                                <div>
                                    <p>CMD_SMOOTH_XYZG_CTRL</p>
                                    <p class="cmd-value">{"T":138,"xyzg":[236.5,0,122.38,0],"spd":0.4}</p>
                                </div>
                                <button class="w-btn">INPUT</button>
                            </div>
                            <div class="info-box json-cmd-info">
                                <div>
                                    <p>CMD_SMOOTH_FPV_ABS_CTRL</p>
                                    <p class="cmd-value">{"T":139,"rbzg":[236.5,0,122.38,0],"spd":0.4,"br":200}</p>
                                </div>
                                <button class="w-btn">INPUT</button>
                            </div>
                            <div class="info-box json-cmd-info">
                ...
                <div style="margin-bottom: 20px;">
                    ...
                    <button class="btn-of btn-all" style="min-width:110px; padding:10px 15px; margin:5px;" onclick='if (confirm("Warning: This will release torque lock. Proceed?")){sendJsonCmd({"T":34,"id":254,"state":0});}'>Release</button>
                    <button class="btn-of btn-all" style="min-width:110px; padding:10px 15px; margin:5px;" onclick='if (confirm("Warning: This will set the current pos as joint_zero. Proceed?")){sendJsonCmd({"T":147});}'>JointCalib</button>
                </div>
            </section>
        </div>
    </main>
    <script>
        ...
        function cmdSend(flag, axis, delta) {
            const jsonData = {
                "T": 146,
                "flag": flag,
                "axis": axis,
